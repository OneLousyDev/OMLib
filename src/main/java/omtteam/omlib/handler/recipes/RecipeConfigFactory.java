...
public class RecipeConfigFactory implements IConditionFactory {
    ...
    public BooleanSupplier parse(JsonContext context, JsonObject json) {
        ...
        if (OMLibModCompatibility.EnderIOLoaded && OMConfig.GENERAL.recipes.equals("enderio") && mod.equals("enderio")) {
            return () -> true;
        } else if (OMLibModCompatibility.MekanismLoaded && OMConfig.GENERAL.recipes.equals("mekanism") && mod.equals("mekanism")) {
            return () -> true;
        } else if (OMConfig.GENERAL.recipes.equals("vanilla") && mod.equals("vanilla")) {
            return () -> true;
        } else if (OMConfig.GENERAL.recipes.equals("auto")) {
